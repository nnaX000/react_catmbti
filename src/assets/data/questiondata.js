export const QuestionData = [
  ...
  },
  {
    ...
    answer:
      '우리 고양이 너무 이쁜 것 같아.. 사람들한테 자랑해야지..! 하며 인스타를 만들어서 사진도 공유하고 소통도 한다.',
  ...
  },
  {
    id: 5,
    title:
      '고양이에 대해서 모르는 부분을 검색하고 있다. 내가 글을 읽는 방법은?',
  ...
  },
  {
    ...
    answer:
      '이건 이렇게 하면 어떨까? 해결책을 함께 생각하며 정보들을 같이 찾아준다.',
  ...
  },
  {
    ...
    answer:
      '우리 고양이 몸무게는 5키로니까 하루세번 몇시에 이만큼 주고 간식은 이때 챙겨줘야겠다 영양제도 미리 챙겨놔야지',
  ...
  },
  {
    ...
    answer:
      '사료를 조금씩 급여해서 고양이의 기호를 테스트해보고 다 잘먹는다면 날짜에 맞춰서 질리지 않도록 바꿔가며 줘야지',
